...
- Compose mounts `./workspace/Arduino:/workspace`, `./workspace/.arduino15:/root/.arduino15`, `./workspace/ArduinoLibraries:/root/Arduino/libraries`, `./outputs:/outputs`, and `/dev:/dev` into gateway.
...
- `arduino-mcp` also mounts `./workspace/ArduinoLibraries:/root/Arduino/libraries`, so library installs are shared across validate/build/flash lanes.
